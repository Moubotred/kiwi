...
from libform.const import Fecha,Config

from libform.core import Base

from selenium.webdriver.common.by import By
from selenium.webdriver.support import expected_conditions as EC
from selenium.common.exceptions import (TimeoutException,NoSuchElementException,ElementClickInterceptedException,ElementNotInteractableException)
from libform.package import EmpaquetadoManual
...
class Widgets(Base):
    def __init__(self,parent:None,config:Config) -> None:
        super(Widgets,self).__init__(parent,config)

        self.componente = EmpaquetadoManual()
